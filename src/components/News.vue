    ...
    <div>
        ...
        <div class="container px-sm-5">
            <div class="brand_nav">
                ...
                <span class="text-secondary" v-text='$t("message.newsmore")'></span>
            </div>
            <ul class="pb-5 mb-5">
                <li v-for="(item,index) in newsList" :key="index" class="clearfix">
                    ...
                    <div class="text_box d-block d-sm-none">
                        <a :href="item.href" class="text_black news_title"> {{item.title}}
                        </a>
                    ...
                    <div class="text_box d-none d-sm-block">
                        <a :href="item.href" class="text_black news_title">
  ...
  data() {
    return {
        ...
        [
            ...
            {"imgsrc":require("../assets/images/news0718.jpg"),"time":"7月18日","title":"【链得得吐槽大会】Usechain，曹辉宁和他的教授朋友们","from":"链得得","href":"http://www.chaindd.com/3094431.html"},
            ...
            {"imgsrc":require("../assets/images/news0521.png"),"time":"5月21日","title":"Usechain创始人曹辉宁：在合法合规前提下引领区块链3.0时代到来","from":"金色财经","href":"https://www.jinse.com/blockchain/194335.html"},
            ...
            {"imgsrc":require("../assets/images/news0503.jpeg"),"time":"5月3日","title":"构建身份区块链 全球首个自我主权身份区块链Usechain启动","from":"搜狐网","href":"http://www.sohu.com/a/230273943_251755"},
            ...
            {"imgsrc":require("../assets/images/news0330.jpeg"),"time":"3月30日","title":"曹辉宁：区块链技术未来发展有可能取代华尔街","from":"亚太第一卫视","href":"http://www.sohu.com/a/226823801_661926"},
            {"imgsrc":require("../assets/images/news0223.jpg"),"time":"2月23日","title":"曹辉宁：ICO应像电影一样，分级监管","from":"碳链价值","href":"https://mp.weixin.qq.com/s/P64612MSjunC-qv7zgXHAw"},
